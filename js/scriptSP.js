    ...
    onClickOnBlock(blockIdx){//try move block and check if puzzle was solved
        if(this.moveBlock(blockIdx)){
            if(this.checkPuzzleSolved()){
            	document.getElementById("revel_block").style.visibility="visible";
    	    	document.getElementById("revel_img").style.height = "100%";
		document.getElementById("revel_img").style.width = "100%";
    	    	document.getElementById("revel_img").src = "static/img/Wiege-animated-esp.gif";
            	console.log("changed");
            }
        }
    }
...
difficulty_buttons.forEach((elem,idx)=>{
    elem.addEventListener('click',(e)=>{
    	...
    	document.getElementById("revel_block").style.visibility="hidden";
    	document.getElementById("revel_img").style.height = "0%";
	document.getElementById("revel_img").style.width = "0%";
    });
});
